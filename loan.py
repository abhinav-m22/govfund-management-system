...
class Loan:
    def _init_(self, root):
        ...
        lbl_tile = Label(self.root, text="Loan Wavier", font=(
...
# Aadhar
        ...
        lbl_aadhar.grid(row=0, column=0, sticky=W, padx=2, pady=7)

        txt_aadhar = ttk.Entry(upper_frame, textvariable=self.var_aadhar,
                               width=22, font=('arial', 11, 'bold'))
        txt_aadhar.grid(row=0, column=1, padx=2, pady=7)
        
        # Loan_Type
        lbl_retYear = Label(upper_frame, font=(
            'arial', 12, 'bold'), text='Loan Type:', bg='white')
        lbl_retYear.grid(row=0, column=2, sticky=W, padx=2, pady=7)

        txt_retYear = ttk.Entry(
            upper_frame, textvariable=self.var_ltype, width=22, font=('arial', 11, 'bold'))
        ...
        # com_txt_gender.grid(row=1, column=3, sticky=W, padx=2, pady=7)
        ...
        # lbl_ifsc.grid(row=3, column=0, sticky=W, padx=2, pady=7)

        # txt_ifsc = ttk.Entry(
        #     upper_frame, textvariable=self.var_bankifsc, width=22, font=('arial', 11, 'bold'))
        # txt_ifsc.grid(row=3, column=1, padx=2, pady=7)
    ...
    def add_data(self):
        ...
        try:
            ...
            Loan_Amount = int(self.var_ltype.get())
            my_cursor.execute('insert into loan values(%s,%s,%s,%s)', (
            ...
            conn.close()
            messagebox.showinfo(
                'Success', 'citizen Registered!', parent=self.root)

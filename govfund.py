...
class Citizen:
    def __init__(self,root):
        ...
        lbl_tile=Label(self.root,text = "FUND MANAGEMENT SYSTEM", font=('times new roman', 37, 'bold'),fg='darkblue',bg='white')
        ...
        # Upper Frame
        upper_frame=LabelFrame(Main_frame, bd=2, relief=RIDGE, bg='white', text='Citizen Information',font=('times new roman', 11, 'bold'),fg='red')
        ...
        # Aadhar
        lbl_aadhar=Label(upper_frame, font=('arial',12,'bold'),text='Aadhar:',bg='white')
        ...
        # PAN 
        lbl_pan=Label(upper_frame, font=('arial',12,'bold'),text='Pan Card:',bg='white')
        lbl_pan.grid(row=2, column=0, sticky=W, padx=2, pady=7)

        txt_pan=ttk.Entry(upper_frame,textvariable=self.var_pan, width=22, font=('arial', 11, 'bold'))
        txt_pan.grid(row=2, column=1, padx=2, pady=7)

        # Disability
        lbl_disable=Label(upper_frame, font=('arial',12,'bold'),text='Disability:',bg='white')
        lbl_disable.grid(row=2, column=2, sticky=W, padx=2, pady=7)

        com_txt_disability=ttk.Combobox(upper_frame,textvariable=self.var_disability, state='readonly', font=('arial',12,'bold'),width=18)
        ...
        # Bank Acc
        lbl_bankacc=Label(upper_frame, font=('arial',12,'bold'),text='Bank A/C:',bg='white')
        lbl_bankacc.grid(row=2, column=4, sticky=W, padx=2, pady=7)

        txt_bankacc=ttk.Entry(upper_frame,textvariable=self.var_bankacc, width=22, font=('arial', 11, 'bold'))
        txt_bankacc.grid(row=2, column=5, padx=2, pady=7)

        # IFSC Code
        lbl_ifsc=Label(upper_frame, font=('arial',12,'bold'),text='IFSC Code:',bg='white')
        lbl_ifsc.grid(row=3, column=4, sticky=W, padx=2, pady=7)

        txt_ifsc=ttk.Entry(upper_frame,textvariable=self.var_bankifsc, width=22, font=('arial', 11, 'bold'))
        ...
        # Down Frame
        down_frame=LabelFrame(Main_frame, bd=2, relief=RIDGE, bg='white', text='Citizen Information Table',font=('times new roman', 11, 'bold'),fg='red')
        down_frame.place(x=10, y=240, width=1235, height=230)

        # Search Frame
        search_frame=LabelFrame(down_frame,bd=2,relief=RIDGE,bg='white',text='Search Citizen Information',font=('times new roman',11,'bold'),fg='red')
        ...
        self.citizen_table=ttk.Treeview(table_frame,column=("citizen_id","citizen_name","citizen_age","citizen_dob","citizen_phone","citizen_aadhar","citizen_pan","citizen_occupation","citizen_disability","citizen_city","citizen_bank_accno","citizen_bank_ifsc"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
    ...
    def add_data(self):
        ...
        # else:
            try:
                ...
                self.fetch_data()
                conn.close() 
                messagebox.showinfo('Success','citizen has been addded!',parent=self.root)
